namespace Cars.Tests.JustMock.Mocks
{
    ...
    public class MoqCarsRepository : CarRepositoryMock, ICarsRepositoryMock
    {
        protected override void ArrangeCarsRepositoryMock()
        {
            ...
            mockedCarsRepository.Setup(r => r.GetById(It.Is<int>(x => x >= 0))).Returns(this.FakeCarCollection.First());
            mockedCarsRepository.Setup(r => r.GetById(It.Is<int>(x => x < 0))).Returns((Car)null);
